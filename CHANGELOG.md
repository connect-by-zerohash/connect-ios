...
- Added `gemini.com` and `robinhood.com` to the default WebView host
  allow-list (subdomains included), so the SDK can load Gemini and
  Robinhood pages during deposit and withdrawal flows.
