...
public class ConnectSDK {
    ...
    public static func configureAuth(
        ...
        return ConnectAuthSession(jwt: jwt, environment: environment, theme: theme, callbacks: callbacks, allowList: allowList)
    }
    ...
    public static func configureRecovery(
        ...
        return ConnectRecoverySession(jwt: jwt, environment: environment, theme: theme, callbacks: callbacks, allowList: allowList)
    }
    ...
    public static func configureWithdrawal(
        ...
        return ConnectWithdrawalSession(jwt: jwt, environment: environment, theme: theme, callbacks: callbacks, allowList: allowList)
    }
}
